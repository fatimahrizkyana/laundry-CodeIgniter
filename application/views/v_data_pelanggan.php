            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <a href="#" class="btn btn-primary float-right" data-toggle="modal" data-target="#tambahpelanggan">
                    ...
                    <div class="col-12">
                        <div class="card mt-3">
                            <table class="table table-striped table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    <tr>
                                        <td id="idpelanggan">1</td>
                                        <td>Fatimah Rizkyana Nuraini</td>
                                        <td>fatimahrizkyananuraini</td>
                                        <td>fatimahrizkyananuraini</td>
                                        <td>081617734428</td>
                                        <td>
                                            <a href="" class="btn btn-success btn-sm"  data-toggle="modal" data-target="#editpelanggan">
                                                <i class="fa fa-pencil-alt" aria-hidden="true"></i> Edit
                                            </a>
                                            <a href="" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapuspelanggan">
    ...
    <div class="example-modal">
        <div class="modal fade" id="tambahpelanggan" role="dialog" style="display: none;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Registrasi Pelanggan Baru</h4>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="nama_pelanggan" placeholder="Nama Pelanggan" value="">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="alamat" id="" cols="30" rows="2" placeholder="Alamat" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group mt-3">
                            <div class="row">
                                <div class="col-sm-3 text-right">
                                    <label class="control-label">
                                        jenis Kelamin <span class="text-red" style="color: red;">*</span>
                                    </label>
                                </div>
                                <div class="col-sm-8">
                                    <label>
                                        <input type="radio" name="radio1" id="" value="Perempuan">
                                        Perempuan
                                    </label>
                                    <label>
                                        <input type="radio" name="radio1" id="" value="Laki-Laki">
                                        Laki-Laki
                                    </label>                                
                                </div>
                            </div>
        ...
        <div class="example-modal">
            <div class="modal fade" id="editpelanggan" role="dialog" style="display: none;">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
